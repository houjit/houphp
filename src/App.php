...
class App
{
    ...
    final public static function run()
    {
        try {
            ...
            self::$houPath = self::$rootPath . DS . 'hou';
            self::$appPath = self::$rootPath . DS . 'app';
    ...
    final public static function autoLoader($class)
    {
        ...
        $findPath = [
            self::$rootPath . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR,
        ];
